...
update_ini_file() {
  cd $current_dir
  wp i18n make-pot . "i18n/languages/$pro_plugin_name.pot" --slug="$pro_plugin_name" --domain="$pro_plugin_name" --include=$pro_plugin_name".php",/App/ --headers='{"Last-Translator":"wployalty","Language-Team":"wployalty"}' --allow-root
  cd $current_dir
